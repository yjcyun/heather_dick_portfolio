    ...
    <Layout>
      ...
      <div className="about-page">
        ...
        <Info img={data.aboutImg.childImageSharp.fluid}>
          ...
          <p>A performer, voice artist, director, writer and Designated Linklater Voice teacher, Heather brings energy, joy and a touch of humour to all that she does.</p>
          <p>
          ...
          <p className="extra-padding">
            Heather and the Sirius Theatrical Company were the recipients of several grants to develop new works including: a Government of Canada Canadian Heritage 1812 Commemoration Fund grant <strong>(Forgotten Voices)</strong>; a City of Toronto’s Cultural Hotspot Signature Partnership Project grant <strong>(My Lakeshore, My Home)</strong>; and a City of Toronto Culture Division - TO Live With Culture grant <strong>(Tapestry of Dreams/Dreamweavers)</strong>. In 2013, Heather and the Sirius Theatrical Company were presented with the <strong>GEM of the LAKESHORE Award for Cultural & Recreation</strong> for their work in “promoting arts and culture in the Lakeshore/Mimico community of Toronto”.  Heather, herself, received the Lakeshore Arts organization’s <strong>Impact Award in 2015</strong> in “recognition of making continuous positive change and using the arts to engage and strengthen” the Lakeshore/Mimico community.
          </p>
          <p>
